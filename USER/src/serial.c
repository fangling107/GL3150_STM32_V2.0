		...
		{	
			...
			{	
				...
				case 0x03://下夹具尘埃粒子计数器						
						...
						Data_Time_down++;
						if(Data_Time_down==6)//一分钟时间到
						{	
							if(No_Loadorclear_Flag==1)
								{
									Data_Time_down=0;	
									Dust_03_Up=Dust_03_Down;
									Dust_05_Up=Dust_05_Down;
									Dust_1_Up=Dust_1_Down;
									Dust_3_Up=Dust_3_Down;
									Dust_5_Up=Dust_5_Down;
									Dust_10_Up=Dust_10_Down;
									Dust_03_Down=0;
									Dust_05_Down=0;
									Dust_1_Down=0;
									Dust_3_Down=0;
							...
							else if(start_testflag==1)//1分钟取样完成，计算出过滤效率
							{							
									Data_Time_down=0;	
									Dust_5_Down=0;
									Dust_10_Down=0;//数据好看
